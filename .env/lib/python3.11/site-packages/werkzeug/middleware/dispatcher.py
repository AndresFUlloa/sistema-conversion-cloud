...
backend app and a frontend written in JavaScript that does the routing
...
This example dispatches to an app app under "/api", an admin app
...
app and admin apps would each be deployed with a separate WSGI server,
