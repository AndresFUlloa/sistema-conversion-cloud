...
class CoverageData(SimpleReprMixin):
    ...
    This class is the public supported app to the data that coverage.py
    ...
    .. note::
        ...
        though, so be careful about querying it directly. Use this app if you
    ...
    * **file tracer names**: the module names of the file tracer plugins that
    ...
    names in this app are case-sensitive, even on platforms with
