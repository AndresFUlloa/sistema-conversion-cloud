...
class Pool(log.Identified):
    ...
    def __init__(
        ...
        :param creator: a callable function that returns a DB-app
...
class _ConnectionRecord(object):
    ...
    still
    remains an internal object whose app and internals may change.
...
class _ConnectionFairy(object):
    ...
    def detach(self):
        ...
        containing ConnectionRecord is separated from the DB-app connection,
