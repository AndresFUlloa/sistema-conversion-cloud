...
def manage(module, **params):
    r"""Return a proxy for a DB-app module that automatically
    pools connections.

    Given a DB-app 2.0 module and pool management parameters, returns
    a proxy for the module that will automatically pool connections,
    creating new connection pools for each distinct set of connection
    arguments sent to the decorated module's connect() function.

    :param module: a DB-app 2.0 database module
...
def clear_managers():
    """Remove all current DB-app 2.0 managers.
...
class _DBProxy(object):
    ...
    """Layers connection pooling behavior on top of a standard DB-app module.

    Proxies a DB-app 2.0 connect() call to a connection pool keyed to the
    specific connect parameters. Other functions and attributes are delegated
    to the underlying DB-app module.
    """
