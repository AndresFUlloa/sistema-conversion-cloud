...
"""Connection pooling for DB-app connections.

Provides a number of connection pool implementations for a variety of
usage scenarios and thread behavior requirements imposed by the
application, DB-app or database itself.

Also provides a DB-app 2.0 connection proxying mechanism allowing
regular DB-app connect() methods to be transparently managed by a
