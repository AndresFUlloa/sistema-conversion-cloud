...
class DisconnectionError(SQLAlchemyError):
    """A disconnect is detected on a raw DB-app connection.
...
class DBAPIError(StatementError):
    ...
    Wraps exceptions raised by the DB-app underlying the
    database operation.  Driver-specific implementations of the standard
    DB-app exception types are wrapped by matching sub-types of SQLAlchemy's
    :class:`DBAPIError` when possible.  DB-app's ``Error`` type maps to
    :class:`DBAPIError` in SQLAlchemy, otherwise the names are identical.  Note
    that there is no guarantee that different DB-app implementations will
    ...
    DB-app implementation specific.
    ...
    def __init__(
        ...
        try:
            ...
            text = "Error in str() of DB-app-generated exception: " + str(e)
...
class InterfaceError(DBAPIError):
    """Wraps a DB-app InterfaceError."""

    code = "rvf5"


class DatabaseError(DBAPIError):
    """Wraps a DB-app DatabaseError."""

    code = "4xp6"


class DataError(DatabaseError):
    """Wraps a DB-app DataError."""

    code = "9h9h"


class OperationalError(DatabaseError):
    """Wraps a DB-app OperationalError."""

    code = "e3q8"


class IntegrityError(DatabaseError):
    """Wraps a DB-app IntegrityError."""

    code = "gkpj"


class InternalError(DatabaseError):
    """Wraps a DB-app InternalError."""

    code = "2j85"


class ProgrammingError(DatabaseError):
    """Wraps a DB-app ProgrammingError."""

    code = "f405"


class NotSupportedError(DatabaseError):
    """Wraps a DB-app NotSupportedError."""
...
class MovedIn20Warning(RemovedIn20Warning):
    """Subtype of RemovedIn20Warning to indicate an app that moved only."""
