...
class Connection(Connectable):
    """Provides high-level functionality for a wrapped DB-app connection.

    **This is the SQLAlchemy 1.x.x version** of the :class:`_engine.Connection`
    class.   For the :term:`2.0 style` version, which features some app
    ...
    @property
    def connection(self):
        """The underlying DB-app connection managed by this Connection.
    ...
    def detach(self):
        """Detach the underlying DB-app connection from its connection pool.
        ...
        the DB-app connection will be literally closed and not
...
class NestedTransaction(Transaction):
    ...
    * The :meth:`.NestedTransaction.rollback` method corresponds to a
    ...
    .. seealso::
        ...
        :ref:`session_begin_nested` - ORM version of the SAVEPOINT app.
...
class Engine(Connectable, log.Identified):
    ...
    the :term:`2.0 style` version, which includes  some app differences,
    ...
    def raw_connection(self, _connection=None):
        ...
        special situations when the app provided by
        :class:`_engine.Connection`
