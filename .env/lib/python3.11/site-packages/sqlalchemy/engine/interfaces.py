...
class Dialect(object):
    """Define the behavior of a specific database and DB-app combination.
    ...
    def create_connect_args(self, url):
        """Build DB-app compatible connection arguments.
    ...
    def has_table(self, connection, table_name, schema=None, **kw):
        ...
        .. note:: This method is used internally by SQLAlchemy, and is
           ...
           implementation. It is **not** the public app for checking for table
    ...
    def is_disconnect(self, e, connection, cursor):
        """Return True if the given DB-app error indicates an invalid
        connection"""
            ...
            class MyPlugin(CreateEnginePlugin):
                def __init__(self, url, kwargs):
                    if hasattr(CreateEnginePlugin, "update_url"):
                        ...
                        # detect the 1.3 and earlier app - mutate the
                        # URL directly
...
class ExecutionContext(object):
    ...
    cursor
      DB-app cursor procured from the connection,
...
class ExceptionContext(object):
    ...
    .. note:: The pool "pre_ping" handler enabled using the
        ...
        <pool_disconnects_pessimistic_custom>`.  A future app allow more
