# -*- coding: utf-8 -*-
"""
Tests for greenlets interacting with the CPython trash can app.

The CPython trash can app is not designed to be re-entered from a
...
class TestTrashCanReEnter(unittest.TestCase):
    ...
    def check_it(self): # pylint:disable=too-many-statements
        ...
        # we can use that app to do better?
